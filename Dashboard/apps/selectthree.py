...
html.Div(style={
        'background-image': 'url(“https://mcdn.wallpapersafari.com/medium/89/74/yZxFK3.jpg”)',
        'background-position': 'center',
        },
        id = 'div1',
         children = [
            html.H1("WELCOME TO THE GAME!"),
             html.Br(),
             html.H3("Select 'Compare Your Team' from the menu above. Use the drop down menu’s to search for or hand select your team."),
             html.Br(),
             html.H3("You can select a total of three teams to compare our dataset options."),
             html.Br(),
             html.H3("Visualizations include penalty yards, rush yards and pass yards for all teams that played games that were not >14 points at the half.")
])
